...
class TreadmillDataCharacteristic(Characteristic):
    ...
    def _send_measurement(self):
        ...
        (speed_m_s, distance_m, energy, elapsed_s) = self.treadmill_app.get_measures()
        ...
        print(f"[Notify] Speed={speed_m_s:.2f} m/s, Dist={distance_m:.1f}m, "
              f"Energy={energy}, Time={elapsed_s}s")
...
class TreadmillApp:
    ...
    """
    def __init__(self, device_name="My-Treadmill"):
        self.device_name = device_name
        self.mainloop = None

        # "Live" treadmill data that the characteristic will read
        self.speed_m_s = 0.833  # default 3 km/h
        self.distance_m = 0.0
        self.energy = 0
        self.elapsed_s = 0

    def set_measures(self, speed_m_s=None, distance_m=None, energy=None, elapsed_s=None):
        """
    ...
    def start(self):
        ...
        try:
            ...
            print(f"Error setting name or restarting adapter: {e}")

        # Create a pairing agent (optional)
        ...
        try:
            agent_manager.RegisterAgent(PairingAgent.AGENT_PATH, "KeyboardDisplay")
            agent_manager.RequestDefaultAgent(PairingAgent.AGENT_PATH)
            print("Pairing agent registered and set as default.")
        except dbus.DBusException as e:
            print(f"Failed to register pairing agent: {e}")

        # Create GATT application with a reference to self
        ...
        try:
            ...
            print("Treadmill GATT application registered.")
        except dbus.DBusException as e:
            print(f"Failed to register GATT application: {e}")
            return

        # Create & register advertisement
